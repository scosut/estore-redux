...
import { registerUser, clearInput, setInput, clearErrors, clearMessage } from '../redux/actionCreators';
...
class RegisterForm extends Component {
  ...
  handleClick = () => {
    this.props.registerUser(this.props.input.user.name, this.props.input.user.email, this.props.input.user.password, this.props.input.user.confirm);
  }
